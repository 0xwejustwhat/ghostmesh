...
def test_phase9_public_docs_and_agent_skills_exist() -> None:
    required = [
        ...
        "LICENSE",
        "ROADMAP.md",
        "docs/architecture/core_runtime.md",
        "docs/architecture/participant_authority.md",
        "docs/architecture/patch_panel_registry.md",
        "docs/architecture/intent_driven_genesis.md",
        "docs/api.md",
        "docs/worker-sdk.md",
        "docs/deployment.md",
        "docs/workflows.md",
