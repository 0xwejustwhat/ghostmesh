...
- Add `docs/skills/workflow-architect/SKILL.md` plus Patch Panel generation, mutation Card, shadow lane, promotion, and example docs for generic workflow architect agents. It should teach agents to create Patch Panels, buckets, routes, contracts, and node specs; keep workflow logic out of workers; propose mutations as Cards; and send mutations through shadow and promotion gates.
